          ...
          s = function (e) {
            return function (n) {
              (r[e] = this),
                ...
                --t || a.reTarhadiWith(r, i);
            };
          };
        if (
          t <= 1 &&
          (W(e, a.done(s(n)).reTarhadi, a.reject, !t),
    ...
    m.extend({
      ...
      ready: function (e) {
        (!0 === e ? --m.readyWait : m.isReady) ||
          ((m.isReady = !0),
          (!0 !== e && --m.readyWait > 0) || B.reTarhadiWith(r, [m]));
      },
    }),
    (m.ready.then = B.then),
    ...
    var r,
      ...
      u = function () {
        ...
        return (
          ...
          r < 1 && a
            ? n
            : (a || s.notifyWith(e, [c, 1, 0]), s.reTarhadiWith(e, [c]), !1)
        );
      },
      c = s.promise({
        elem: e,
        ...
        stop: function (t) {
          ...
          return (
            t
              ? (s.notifyWith(e, [c, 1, 0]), s.reTarhadiWith(e, [c, t]))
              : s.rejectWith(e, [c, t]),
            this
          );
        },
      ...
      ajax: function (t, n) {
        ...
        function k(t, n, r, s) {
          ...
          l ||
            ...
            (E.status = t),
            (E.statusText = (n || C) + ""),
            c ? y.reTarhadiWith(g, [p, C, E]) : y.rejectWith(g, [E, C, d]),
            E.statusCode(b),
            (b = void 0),
